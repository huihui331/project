...
// import img from '@assets/images/patterns/jigsaw-thumbnail.svg'
...
let patternsData = reactive([
  {
    ...
    src: getPatternFile('jigsaw-thumbnail.svg'),
    alt: 'jigsaw花样',
    initPatternSize: '100',
  },
  {
    ...
    src: getPatternFile('github-thumbnail.svg'),
    alt: 'github花样',
    initPatternSize: '40',
  },
  {
    ...
    src: getPatternFile('endless-constellation-thumbnail.svg'),
  ...
  },
  {
    ...
    src: getPatternFile('floating-cogs-thumbnail.svg'),
    alt: 'floating-cogs花样',
    initPatternSize: '350',
  },
  {
    ...
    src: getPatternFile('bubbles-thumbnail.svg'),
    alt: 'bubbles花样',
    initPatternSize: '200',
  },
  {
    ...
    src: getPatternFile('lisbon-thumbnail.svg'),
    alt: 'lisbon花样',
    initPatternSize: '80',
  },
  {
    ...
    src: getPatternFile('temple-thumbnail.svg'),
    alt: 'temple花样',
    initPatternSize: '100',
  },
  {
    ...
    src: getPatternFile('topography-thumbnail.svg'),
    alt: 'topography花样',
    initPatternSize: '500',
  },
  {
    ...
    src: getPatternFile('falling-triangles-thumbnail.svg'),
  ...
  },
  {
    ...
    src: getPatternFile('glamorous-thumbnail.svg'),
    alt: 'glamorous花样',
    initPatternSize: '135',
  },
  {
    ...
    src: getPatternFile('i-like-food-thumbnail.svg'),
    alt: 'i-like-food花样',
    initPatternSize: '225',
  },
  {
    ...
    src: getPatternFile('leaf-thumbnail.svg'),
    alt: 'leaf花样',
    initPatternSize: '80',
  },
  {
    ...
    src: getPatternFile('circuit-board-thumbnail.svg'),
    alt: 'circuit-board花样',
    initPatternSize: '304',
  },
  {
    ...
    src: getPatternFile('overlapping-circles-thumbnail.svg'),
  ...
  },
  {
    ...
    src: getPatternFile('endless-clouds-thumbnail.svg'),
